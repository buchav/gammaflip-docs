...
Typos and clarifications are welcome via pull request. For substantial content
changes, open an issue first.

## License

Docs: CC-BY-4.0. The API itself is a commercial product — see
[gammaflip.io](https://gammaflip.io) for subscription details.
